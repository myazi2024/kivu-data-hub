-- Créer la configuration map_preview_settings si elle n'existe pas
INSERT INTO cadastral_contribution_config (
  config_key,
  config_value,
  description,
  is_active
...
SELECT 
  ...
  'Configuration de la carte interactive pour les coordonnées GPS des parcelles',
  true
WHERE NOT EXISTS (
  SELECT 1 FROM cadastral_contribution_config 
