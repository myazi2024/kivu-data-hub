-- FIX: Align calculate_ccc_value with frontend scoring
-- 1. Add property_category to scoring
-- 2. Make lease_type conditional (only when property_title_type is 'Contrat de location')
...
BEGIN
  ...
  -- SECTION 2: General info = 13 base fields + conditional leaseType
  total_fields := total_fields + 13;
