-- Supprimer l'ancien numéro SU test
DELETE FROM public.cadastral_parcels WHERE parcel_number = 'SU/GMA/2024/TEST-001';

-- Créer un nouveau numéro SU test avec un format valide
