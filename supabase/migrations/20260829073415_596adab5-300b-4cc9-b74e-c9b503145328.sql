ALTER TABLE public.cadastral_contributions
  ADD COLUMN IF NOT EXISTS apartment_length numeric,
  ADD COLUMN IF NOT EXISTS apartment_width numeric,
  ADD COLUMN IF NOT EXISTS apartment_height numeric,
  ADD COLUMN IF NOT EXISTS apartment_orientation text;
  ...
  IF NEW.status = 'approved' AND OLD.status IS DISTINCT FROM 'approved' THEN
    ...
    IF NEW.original_parcel_id IS NOT NULL THEN
      ...
      SET
        ...
        apartment_length = COALESCE(NEW.apartment_length, apartment_length),
        apartment_width = COALESCE(NEW.apartment_width, apartment_width),
        apartment_height = COALESCE(NEW.apartment_height, apartment_height),
