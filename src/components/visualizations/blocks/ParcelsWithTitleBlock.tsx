    ...
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-5 gap-1.5">
        {[
          ...
          { label: 'Avec hyp.', value: parcelIdsWithMortgage.size, cls: 'text-rose-600' },
          { label: 'Dur. hyp.', value: `${avgMortgageDuration}m`, cls: 'text-purple-600' },
        ].map((kpi, i) => (
      ...
      <div className="grid grid-cols-2 gap-2">
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px] flex items-center gap-1"><FileText className="h-3 w-3 text-primary" /> Type titre</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px] flex items-center gap-1"><Users className="h-3 w-3 text-primary" /> Propriétaires</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px] flex items-center gap-1"><Users className="h-3 w-3 text-pink-500" /> Genre</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px] flex items-center gap-1"><Building className="h-3 w-3 text-primary" /> Construction</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px] flex items-center gap-1"><Shield className="h-3 w-3 text-primary" /> Autorisation bâtir</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px]">Usage déclaré</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px]">Créanciers</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px]">Statut hyp.</CardTitle></CardHeader>
