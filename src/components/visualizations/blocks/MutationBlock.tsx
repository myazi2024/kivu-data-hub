  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px] flex items-center gap-1"><ArrowRightLeft className="h-3 w-3 text-primary" /> Statut</CardTitle></CardHeader>
        ...
        <Card className="border-border/30"><CardHeader className="pb-1 px-2 pt-2"><CardTitle className="text-[10px]">Type mutation</CardTitle></CardHeader>
