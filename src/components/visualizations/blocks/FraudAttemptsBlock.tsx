...
import { ShieldAlert, TrendingUp, AlertTriangle, Link2, BarChart3 } from 'lucide-react';
...
export const FraudAttemptsBlock: React.FC<Props> = memo(({ data }) => {
  ...
  return (
    ...
    <div className="space-y-2">
      <AnalyticsFilters data={data.fraudAttempts} filter={filter} onChange={setFilter} hidePaymentStatus />
