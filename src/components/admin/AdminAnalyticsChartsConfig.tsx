            ...
            <CardContent>
              <ScrollArea className="h-[460px]">
                <div className="space-y-4">
                  ...
                  {/* ─── Global watermark logo config ─── */}
                  {activeTab === '_global' && currentCharts.length > 0 && (() => {
                    const opacityItem = currentCharts.find(c => c.item_key === 'logo-watermark-opacity');
                    const sizeItem = currentCharts.find(c => c.item_key === 'logo-watermark-size');
                    const posItem = currentCharts.find(c => c.item_key === 'logo-watermark-position');
                    const watermarkItem = currentCharts.find(c => c.item_key === 'global-watermark');
                      ...
                      <div className="space-y-4">
                        ...
                        {watermarkItem && (
                          <div>
                            ...
                            <Input
                              value={watermarkItem.custom_title || ''}
                              onChange={(e) => updateItem('global-watermark', { ...watermarkItem, custom_title: e.target.value })}
                        ...
                        {opacityItem && (
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => updateItem('logo-watermark-opacity', { ...opacityItem, custom_title: (parseInt(e.target.value) / 100).toFixed(2) })}
                        ...
                        {sizeItem && (
                          <div>
                            ...
                            <input
                              ...
                              step={5}
                              value={size}
                              onChange={(e) => updateItem('logo-watermark-size', { ...sizeItem, custom_title: e.target.value })}
                              className="w-full h-2 mt-1 accent-primary"
                            />
                          </div>
                        )}
                        ...
                        {posItem && (
                          <div>
                            ...
                            <Select value={position} onValueChange={(v) => updateItem('logo-watermark-position', { ...posItem, custom_title: v })}>
                  ...
                  {/* Charts section — skip for rdc-map and _global (already shown above) */}
