...
export const menuItems: AdminMenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Percent, label: 'Commissions revendeurs', value: 'reseller-commissions', badge: null, keywords: ['agent', 'partenaire', 'commission', 'analytique', 'vente', 'revendeur', 'pipeline'] },
