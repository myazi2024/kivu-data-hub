...
export const menuItems: AdminMenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Grid3X3, label: 'Lotissement', value: 'subdivision-hub', badge: 'subdivisions', keywords: ['division', 'morcellement', 'parcellisation', 'lotissement', 'frais', 'tarif', 'zonage', 'urbanisme', 'lots', 'voies', 'analytics', 'kpi'] },
