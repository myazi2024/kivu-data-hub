                                       ...
                                       <Button
                                         ...
                                         onClick={() => {
                                           ...
                                           openConfirmationModal(
                                             landRegistryUrl,
                                             "Vérification du PV de bornage",
                                             "Vous allez être redirigé vers le site de la circonscription foncière pour vérifier l'authenticité du procès-verbal de bornage.",
                                             parcel.location
                                           );
                                         }}
                                       >
                             ...
                             <div className="flex items-center gap-1">
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    openConfirmationModal(
                                      ownerVerificationUrl,
                                      "Vérification du propriétaire actuel",
                                      "Vous allez être redirigé vers le site de la circonscription foncière pour vérifier l'authenticité du document de propriété.",
                                   ...
                                   <div className="flex items-center gap-1">
                                      <Button
                                        ...
                                        onClick={() => {
                                          ...
                                          openConfirmationModal(
                                            taxVerificationUrl,
                                            "Vérification de taxe foncière",
                                            "Vous allez être redirigé vers le site de la circonscription foncière pour vérifier l'authenticité du document fiscal.",
                                            `${parcel.commune}, ${parcel.quartier}`
                                          );
                                        }}
                                      >
                                     ...
                                     <div className="flex items-center gap-1">
                                        <Button
                                          ...
                                          onClick={() => {
                                            ...
                                            openConfirmationModal(
                                              mortgageVerificationUrl,
                                              "Vérification de l'hypothèque",
                                              "Vous allez être redirigé vers le site de la circonscription foncière pour vérifier l'authenticité du document d'hypothèque.",
                                              `${parcel.commune}, ${parcel.quartier}`
                                            );
                                          }}
                                        >
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted/30 rounded-lg border border-border/50">
              ...
              <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
                <MapPin className="h-3 w-3" />
                <span>Localisation: {confirmationModal.location}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-xs text-blue-700 dark:text-blue-300">
                Vous allez quitter cette application et être redirigé vers le site officiel de la circonscription foncière.
              </p>
            </div>
          </div>
