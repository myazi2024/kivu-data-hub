        ...
        <Tabs value={activeTab} className="w-full" onValueChange={handleTabChange}>
          ...
          <TabsContent value="general" className="mt-0 focus-visible:outline-none focus-visible:ring-0">
            <GeneralTab
              ...
              setCustomTitleName={setCustomTitleName}
              leaseYears={leaseYears}
              setLeaseYears={setLeaseYears}
          ...
          <TabsContent value="location" className="mt-0 focus-visible:outline-none focus-visible:ring-0">
            <LocationTab
              ...
              sectionTypeAutoDetected={sectionTypeAutoDetected}
              ...
              availableAvenues={availableAvenues}
          ...
          <TabsContent value="history" className="mt-0 focus-visible:outline-none focus-visible:ring-0">
            <HistoryTab
              ...
              updatePreviousOwner={updatePreviousOwner}
              addPreviousOwner={addPreviousOwner}
              removePreviousOwner={removePreviousOwner}
              highlightIncompletePreviousOwner={highlightIncompletePreviousOwner}
              showCurrentOwnerRequiredWarning={showCurrentOwnerRequiredWarning}
              showPreviousOwnerWarning={showPreviousOwnerWarning}
              getPicklistOptions={getPicklistOptions}
              handleTabChange={handleTabChange}
              handleNextTab={handleNextTab}
              toast={toast}
          ...
          <TabsContent value="obligations" className="mt-0 focus-visible:outline-none focus-visible:ring-0">
            <ObligationsTab
              ...
              setObligationType={setObligationType}
              taxRecords={taxRecords}
              updateTaxRecord={updateTaxRecord}
              addTaxRecord={addTaxRecord}
              removeTaxRecord={removeTaxRecord}
              handleTaxFileChange={handleTaxFileChange}
              removeTaxFile={removeTaxFile}
              showTaxWarning={showTaxWarning}
              highlightIncompleteTax={highlightIncompleteTax}
              hasMortgage={hasMortgage}
              setHasMortgage={setHasMortgage}
              mortgageRecords={mortgageRecords}
              setMortgageRecords={setMortgageRecords}
              updateMortgageRecord={updateMortgageRecord}
              addMortgageRecord={addMortgageRecord}
              removeMortgageRecord={removeMortgageRecord}
              handleMortgageFileChange={handleMortgageFileChange}
              removeMortgageFile={removeMortgageFile}
              showMortgageWarning={showMortgageWarning}
              highlightIncompleteMortgage={highlightIncompleteMortgage}
              getPicklistOptions={getPicklistOptions}
              handleTabChange={handleTabChange}
              handleNextTab={handleNextTab}
            />
          ...
          <TabsContent value="review" className="mt-0 focus-visible:outline-none focus-visible:ring-0">
            <ReviewTab
              ...
              leaseYears={leaseYears}
              customTitleName={customTitleName}
              calculateCCCValue={calculateCCCValue}
              isFormValidForSubmission={isFormValidForSubmission}
              getMissingFields={getMissingFields}
              handleSubmit={handleSubmit}
              handleTabChange={handleTabChange}
              saveFormDataToStorage={saveFormDataToStorage}
              setShowQuickAuth={setShowQuickAuth}
