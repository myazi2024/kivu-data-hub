...
import {
  DollarSign, ChevronLeft, Send, AlertTriangle, CheckCircle2, Home, Building2
} from 'lucide-react';
        ...
        <CardContent className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            <h4 className="text-sm font-semibold flex items-center gap-1.5">
              ...
              Calcul de l'Impôt sur le Revenu Locatif
              <SectionHelpPopover
                title="IRL — 22%"
          ...
          <div className="flex justify-between text-base font-bold">
            ...
            <span className="text-blue-600">{(result.irlAmount + result.totalFees).toLocaleString()} USD</span>
          </div>
          ...
          <div className="p-3 bg-destructive/10 rounded-xl border border-destructive/30">
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs text-destructive font-medium">
                Cette fiche de déclaration sera transmise à la Direction Générale des Recettes (DGR). Une fois soumise, elle ne peut plus être modifiée.
              </p>
            </div>
          </div>
          ...
          <div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-800">
            <p className="text-xs text-blue-700 dark:text-blue-300">
              ℹ️ Cette estimation est indicative. Le montant définitif peut varier selon l'évaluation de l'administration fiscale.
            </p>
          </div>
        </CardContent>
      </Card>
