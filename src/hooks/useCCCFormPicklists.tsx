...
export const CCC_STATIC_PICKLIST_REGISTRY: Record<string, {
  ...
  picklist_construction_type: {
    ...
    description: 'Types de construction de la parcelle',
  ...
  picklist_declared_usage: {
    ...
    fallback: {
      ...
      'Résidentielle_Durable': ['Habitation', 'Location', 'Usage mixte'],
      'Résidentielle_Semi-durable': ['Habitation', 'Location', 'Usage mixte'],
      'Résidentielle_Précaire': ['Habitation'],
      'Commerciale_Durable': ['Commerce', 'Bureau', 'Location', 'Usage mixte', 'Entrepôt'],
      'Commerciale_Semi-durable': ['Commerce', 'Bureau', 'Location', 'Entrepôt'],
