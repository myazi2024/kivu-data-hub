...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  'title-requests': {
    ...
    charts: [
      ...
      { tab_key: 'title-requests', item_key: 'construction-materials', item_type: 'chart', is_visible: true, display_order: 13, custom_title: 'Matériaux', chart_type: 'bar-h' },
      { tab_key: 'title-requests', item_key: 'standing', item_type: 'chart', is_visible: true, display_order: 14, custom_title: 'Standing', chart_type: 'donut' },
      { tab_key: 'title-requests', item_key: 'revenue-trend', item_type: 'chart', is_visible: true, display_order: 15, custom_title: 'Revenus/mois', chart_type: 'area' },
      { tab_key: 'title-requests', item_key: 'processing-comparison', item_type: 'chart', is_visible: true, display_order: 16, custom_title: 'Délai estimé vs réel', chart_type: 'bar-v' },
      { tab_key: 'title-requests', item_key: 'geo', item_type: 'chart', is_visible: true, display_order: 17, custom_title: 'Géographie' },
  ...
  'parcels-titled': {
    ...
    kpis: [
      { tab_key: 'parcels-titled', item_key: 'kpi-cert-enregistrement', item_type: 'kpi', is_visible: true, display_order: 0, custom_title: "Certificat d'enregistrement" },
      { tab_key: 'parcels-titled', item_key: 'kpi-contrat-location', item_type: 'kpi', is_visible: true, display_order: 1, custom_title: 'Contrat de location' },
      { tab_key: 'parcels-titled', item_key: 'kpi-fiche-parcellaire', item_type: 'kpi', is_visible: true, display_order: 2, custom_title: 'Fiche parcellaire' },
      { tab_key: 'parcels-titled', item_key: 'kpi-titres-demandes', item_type: 'kpi', is_visible: true, display_order: 3, custom_title: 'Titres demandés' },
      { tab_key: 'parcels-titled', item_key: 'kpi-litiges', item_type: 'kpi', is_visible: true, display_order: 4, custom_title: 'Litiges fonciers' },
      { tab_key: 'parcels-titled', item_key: 'kpi-hypotheques-actives', item_type: 'kpi', is_visible: true, display_order: 5, custom_title: 'Hypothèques actives' },
      { tab_key: 'parcels-titled', item_key: 'kpi-mutations-cours', item_type: 'kpi', is_visible: true, display_order: 6, custom_title: 'Mutations en cours' },
      { tab_key: 'parcels-titled', item_key: 'kpi-expertises-cours', item_type: 'kpi', is_visible: true, display_order: 7, custom_title: 'Expertises en cours' },
      { tab_key: 'parcels-titled', item_key: 'kpi-superficie-moy', item_type: 'kpi', is_visible: true, display_order: 8, custom_title: 'Superficie moy. parcelle' },
      { tab_key: 'parcels-titled', item_key: 'kpi-superficie-construction-moy', item_type: 'kpi', is_visible: true, display_order: 9, custom_title: 'Superficie moy. construction' },
      { tab_key: 'parcels-titled', item_key: 'kpi-hauteur-construction-moy', item_type: 'kpi', is_visible: true, display_order: 10, custom_title: 'Hauteur moy. construction' },
    ],
  },
  'contributions': {
    label: 'Contributions',
