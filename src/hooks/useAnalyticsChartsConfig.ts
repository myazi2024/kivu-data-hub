...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  ...
  'parcels-titled': {
    ...
    charts: [
      ...
      { tab_key: 'parcels-titled', item_key: 'surface', item_type: 'chart', is_visible: true, display_order: 12, custom_title: 'Superficie', chart_type: 'bar-v' },
      { tab_key: 'parcels-titled', item_key: 'taxes', item_type: 'chart', is_visible: true, display_order: 13, custom_title: 'Taxes', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'taxes-year', item_type: 'chart', is_visible: true, display_order: 14, custom_title: 'Taxes/année' },
      { tab_key: 'parcels-titled', item_key: 'taxes-amount', item_type: 'chart', is_visible: true, display_order: 15, custom_title: 'Montants taxes/an', chart_type: 'area' },
