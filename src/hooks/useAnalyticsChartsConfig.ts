...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  ...
  'building-permits': {
    ...
    charts: [
      ...
      { tab_key: 'building-permits', item_key: 'estimated-cost', item_type: 'chart', is_visible: true, display_order: 5, custom_title: 'Coût estimé', chart_type: 'bar-v' },
      { tab_key: 'building-permits', item_key: 'roofing-type', item_type: 'chart', is_visible: true, display_order: 6, custom_title: 'Type toiture', chart_type: 'donut' },
      { tab_key: 'building-permits', item_key: 'water-supply', item_type: 'chart', is_visible: true, display_order: 7, custom_title: 'Alimentation eau', chart_type: 'pie' },
      { tab_key: 'building-permits', item_key: 'electricity', item_type: 'chart', is_visible: true, display_order: 8, custom_title: 'Alimentation élec.', chart_type: 'pie' },
      { tab_key: 'building-permits', item_key: 'payment', item_type: 'chart', is_visible: true, display_order: 9, custom_title: 'Paiement', chart_type: 'donut' },
      { tab_key: 'building-permits', item_key: 'geo', item_type: 'chart', is_visible: true, display_order: 10, custom_title: 'Géographie' },
      { tab_key: 'building-permits', item_key: 'evolution', item_type: 'chart', is_visible: true, display_order: 11, custom_title: 'Évolution', chart_type: 'area', col_span: 2 },
    ],
    kpis: [
