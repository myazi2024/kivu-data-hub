...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  ...
  'contributions': {
    ...
    charts: [
      ...
      { tab_key: 'contributions', item_key: 'fraud-detection', item_type: 'chart', is_visible: true, display_order: 4, custom_title: 'Détection fraude', chart_type: 'pie' },
      { tab_key: 'contributions', item_key: 'fraud-score', item_type: 'chart', is_visible: true, display_order: 5, custom_title: 'Score fraude', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'fraud-reason', item_type: 'chart', is_visible: true, display_order: 6, custom_title: 'Motif fraude', chart_type: 'bar-h' },
      { tab_key: 'contributions', item_key: 'appeal-status', item_type: 'chart', is_visible: true, display_order: 7, custom_title: 'Statut appel', chart_type: 'donut' },
      { tab_key: 'contributions', item_key: 'geo', item_type: 'chart', is_visible: true, display_order: 8, custom_title: 'Géographie' },
      { tab_key: 'contributions', item_key: 'evolution', item_type: 'chart', is_visible: true, display_order: 9, custom_title: 'Évolution', chart_type: 'area', col_span: 2 },
    ],
    kpis: [
