...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  ...
  'parcels-titled': {
    ...
    kpis: [
      { tab_key: 'parcels-titled', item_key: 'kpi-certificat', item_type: 'kpi', is_visible: true, display_order: 0, custom_title: 'Certificat enreg.' },
      { tab_key: 'parcels-titled', item_key: 'kpi-contrat', item_type: 'kpi', is_visible: true, display_order: 1, custom_title: 'Contrat location' },
      { tab_key: 'parcels-titled', item_key: 'kpi-fiche', item_type: 'kpi', is_visible: true, display_order: 2, custom_title: 'Fiche parcellaire' },
      { tab_key: 'parcels-titled', item_key: 'kpi-titres', item_type: 'kpi', is_visible: true, display_order: 3, custom_title: 'Titres demandés' },
      { tab_key: 'parcels-titled', item_key: 'kpi-litiges', item_type: 'kpi', is_visible: true, display_order: 4, custom_title: 'Litiges fonciers' },
      { tab_key: 'parcels-titled', item_key: 'kpi-hypotheques', item_type: 'kpi', is_visible: true, display_order: 5, custom_title: 'Hypothèques actives' },
      { tab_key: 'parcels-titled', item_key: 'kpi-mutations', item_type: 'kpi', is_visible: true, display_order: 6, custom_title: 'Mutations en cours' },
      { tab_key: 'parcels-titled', item_key: 'kpi-expertises', item_type: 'kpi', is_visible: true, display_order: 7, custom_title: 'Expertises en cours' },
      { tab_key: 'parcels-titled', item_key: 'kpi-surf-parcelle', item_type: 'kpi', is_visible: true, display_order: 8, custom_title: 'Sup. moy. parcelle' },
      { tab_key: 'parcels-titled', item_key: 'kpi-surf-construction', item_type: 'kpi', is_visible: true, display_order: 9, custom_title: 'Sup. moy. construction' },
      { tab_key: 'parcels-titled', item_key: 'kpi-hauteur-construction', item_type: 'kpi', is_visible: true, display_order: 10, custom_title: 'Haut. moy. construction' },
    ],
  },
  'contributions': {
    label: 'Contributions',
