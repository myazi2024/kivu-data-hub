...
export const useCadastralBilling = () => {
  ...
  const createInvoice = async (searchResult: CadastralSearchResult) => {
    ...
    try {
      ...
      // En mode test : pas besoin de créer en base de données
      // if (user) {
      ...
      //   setCurrentInvoice({...invoice, selected_services: selectedServices as any} as CadastralInvoice);
      // } else {
      ...
      toast({
        ...
        description: "Vous pouvez maintenant consulter les données cadastrales"
      });
