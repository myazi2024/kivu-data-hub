...
const tabComponents: Record<string, React.LazyExoticComponent<any>> = {
  ...
  'credit-notes': lazy(() => import('@/components/admin/AdminCreditNotes')),
  'refunds': lazy(() => import('@/components/admin/AdminRefunds')),
  'invoice-reminders': lazy(() => import('@/components/admin/AdminInvoiceReminders')),
  'fec-export': lazy(() => import('@/components/admin/AdminFECExport')),
  'fiscal-periods': lazy(() => import('@/components/admin/AdminFiscalPeriods')),
  'accounting-journal': lazy(() => import('@/components/admin/AdminAccountingJournal')),
  'tva-reporting': lazy(() => import('@/components/admin/AdminTvaReporting')),
  ...
  'subdivision-lots': lazy(() => import('@/components/admin/AdminSubdivisionLots')),
  'subdivision-analytics': lazy(() => import('@/components/admin/AdminSubdivisionAnalytics')),
