...
import ParcelInfoPanel from '@/components/cadastral/ParcelInfoPanel';
      ...
      <main className="flex-1" style={{ height: 'calc(100vh - 4rem)' }}>
        ...
        {selectedParcel && (
          <ParcelInfoPanel
            ...
            onReportMissingData={() => setShowContributionDialog(true)}
            calculatedArea={
              selectedParcel.gps_coordinates && selectedParcel.gps_coordinates.length >= 3
                ? calculateAreaFromCoordinates(selectedParcel.gps_coordinates)
                : undefined
            }
          />
        )}
