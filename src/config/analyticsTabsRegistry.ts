...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  ...
  'parcels-titled': {
    ...
    charts: [
      ...
      { tab_key: 'parcels-titled', item_key: 'sound-env', item_type: 'chart', is_visible: true, display_order: 13, custom_title: 'Env. sonore', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'noise-sources', item_type: 'chart', is_visible: true, display_order: 14, custom_title: 'Sources de bruit', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'construction-geo', item_type: 'chart', is_visible: true, display_order: 15, custom_title: 'Géographie constructions' },
      { tab_key: 'parcels-titled', item_key: 'construction-evolution', item_type: 'chart', is_visible: true, display_order: 16, custom_title: 'Évolution constructions', chart_type: 'area', col_span: 2 },
    ],
    kpis: [
      ...
      { tab_key: 'parcels-titled', item_key: 'kpi-multi-constr', item_type: 'kpi', is_visible: true, display_order: 3, custom_title: 'Multi-constructions' },
    ],
  },
  'contributions': {
    label: 'Contributions',
