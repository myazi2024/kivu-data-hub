...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  ...
  'parcels-titled': {
    label: 'Parcelles',
    charts: [
      { tab_key: 'parcels-titled', item_key: 'legal-status', item_type: 'chart', is_visible: true, display_order: 0, custom_title: 'Propriétaires', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'gender', item_type: 'chart', is_visible: true, display_order: 1, custom_title: 'Genre propriétaires', chart_type: 'pie' },
      { tab_key: 'parcels-titled', item_key: 'property-category', item_type: 'chart', is_visible: true, display_order: 2, custom_title: 'Catégorie de bien', chart_type: 'bar-h' },
      ...
      { tab_key: 'parcels-titled', item_key: 'construction-materials', item_type: 'chart', is_visible: true, display_order: 5, custom_title: 'Matériaux', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'standing', item_type: 'chart', is_visible: true, display_order: 6, custom_title: 'Standing', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'construction-decade', item_type: 'chart', is_visible: true, display_order: 7, custom_title: 'Année construction', chart_type: 'bar-v' },
      { tab_key: 'parcels-titled', item_key: 'usage', item_type: 'chart', is_visible: true, display_order: 8, custom_title: 'Usage déclaré', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'surface', item_type: 'chart', is_visible: true, display_order: 9, custom_title: 'Superficie', chart_type: 'bar-v' },
      { tab_key: 'parcels-titled', item_key: 'subdivided', item_type: 'chart', is_visible: true, display_order: 10, custom_title: 'Loties vs Non loties', chart_type: 'pie' },
      { tab_key: 'parcels-titled', item_key: 'geo', item_type: 'chart', is_visible: true, display_order: 11, custom_title: 'Géographie' },
      { tab_key: 'parcels-titled', item_key: 'permit-type', item_type: 'chart', is_visible: true, display_order: 12, custom_title: 'Autorisation de bâtir', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'building-size', item_type: 'chart', is_visible: true, display_order: 13, custom_title: 'Taille construction', chart_type: 'bar-v' },
