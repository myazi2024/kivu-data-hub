...
export const ANALYTICS_TABS_REGISTRY: Record<string, { label: string; charts: ChartConfigItem[]; kpis: ChartConfigItem[] }> = {
  'title-requests': {
    ...
    charts: [
      { tab_key: 'title-requests', item_key: 'title-type', item_type: 'chart', is_visible: true, display_order: 0, custom_title: 'Type de titre', chart_type: 'bar-h' },
      { tab_key: 'title-requests', item_key: 'lease-type', item_type: 'chart', is_visible: true, display_order: 1, custom_title: 'Type de bail', chart_type: 'pie' },
      { tab_key: 'title-requests', item_key: 'lease-duration', item_type: 'chart', is_visible: true, display_order: 2, custom_title: 'Durée de bail', chart_type: 'bar-v' },
      { tab_key: 'title-requests', item_key: 'issue-year', item_type: 'chart', is_visible: true, display_order: 3, custom_title: 'Année de délivrance', chart_type: 'bar-v' },
      { tab_key: 'title-requests', item_key: 'issue-trend', item_type: 'chart', is_visible: true, display_order: 4, custom_title: 'Évolution des titres', chart_type: 'area', col_span: 2 },
      { tab_key: 'title-requests', item_key: 'legal-status', item_type: 'chart', is_visible: true, display_order: 5, custom_title: 'Statut juridique', chart_type: 'donut' },
      { tab_key: 'title-requests', item_key: 'gender', item_type: 'chart', is_visible: true, display_order: 6, custom_title: 'Genre (pers. physique)', chart_type: 'pie' },
      { tab_key: 'title-requests', item_key: 'nationality', item_type: 'chart', is_visible: true, display_order: 7, custom_title: 'Nationalité', chart_type: 'pie' },
      { tab_key: 'title-requests', item_key: 'entity-type', item_type: 'chart', is_visible: true, display_order: 8, custom_title: 'Type d\'entité (pers. morale)', chart_type: 'bar-h' },
      { tab_key: 'title-requests', item_key: 'right-type', item_type: 'chart', is_visible: true, display_order: 9, custom_title: 'Droit de l\'État', chart_type: 'pie' },
      { tab_key: 'title-requests', item_key: 'owner-duration', item_type: 'chart', is_visible: true, display_order: 10, custom_title: 'Ancienneté de détention', chart_type: 'bar-v' },
      { tab_key: 'title-requests', item_key: 'mutation-type', item_type: 'chart', is_visible: true, display_order: 11, custom_title: 'Type de mutation', chart_type: 'bar-h' },
  ...
  'parcels-titled': {
    label: 'Construction',
    charts: [
      { tab_key: 'parcels-titled', item_key: 'property-category', item_type: 'chart', is_visible: true, display_order: 0, custom_title: 'Catégorie de bien', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'built-vs-unbuilt', item_type: 'chart', is_visible: true, display_order: 1, custom_title: 'Construites vs Non construites', chart_type: 'pie' },
      { tab_key: 'parcels-titled', item_key: 'construction-type', item_type: 'chart', is_visible: true, display_order: 2, custom_title: 'Construction', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'construction-nature', item_type: 'chart', is_visible: true, display_order: 3, custom_title: 'Nature construction', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'construction-materials', item_type: 'chart', is_visible: true, display_order: 4, custom_title: 'Matériaux', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'standing', item_type: 'chart', is_visible: true, display_order: 5, custom_title: 'Standing', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'construction-decade', item_type: 'chart', is_visible: true, display_order: 6, custom_title: 'Année construction', chart_type: 'bar-v' },
      { tab_key: 'parcels-titled', item_key: 'usage', item_type: 'chart', is_visible: true, display_order: 7, custom_title: 'Usage déclaré', chart_type: 'bar-h' },
      ...
      { tab_key: 'parcels-titled', item_key: 'occupancy-pressure', item_type: 'chart', is_visible: true, display_order: 14, custom_title: "Pression d'occupation", chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'sound-env', item_type: 'chart', is_visible: true, display_order: 15, custom_title: 'Env. sonore', chart_type: 'donut' },
      { tab_key: 'parcels-titled', item_key: 'noise-sources', item_type: 'chart', is_visible: true, display_order: 16, custom_title: 'Sources de bruit', chart_type: 'bar-h' },
      { tab_key: 'parcels-titled', item_key: 'construction-geo', item_type: 'chart', is_visible: true, display_order: 17, custom_title: 'Géographie constructions' },
      { tab_key: 'parcels-titled', item_key: 'construction-evolution', item_type: 'chart', is_visible: true, display_order: 18, custom_title: 'Évolution constructions', chart_type: 'area', col_span: 2 },
    ],
    kpis: [
      { tab_key: 'parcels-titled', item_key: 'kpi-constructions', item_type: 'kpi', is_visible: true, display_order: 0, custom_title: 'Constructions' },
      { tab_key: 'parcels-titled', item_key: 'kpi-occupied', item_type: 'kpi', is_visible: true, display_order: 1, custom_title: 'Habitées' },
  ...
  'contributions': {
    ...
    charts: [
      ...
      { tab_key: 'contributions', item_key: 'area-distribution', item_type: 'chart', is_visible: true, display_order: 14, custom_title: 'Distribution surface', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'construction-decade', item_type: 'chart', is_visible: true, display_order: 15, custom_title: 'Année construction', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'construction-materials', item_type: 'chart', is_visible: true, display_order: 16, custom_title: 'Matériaux', chart_type: 'bar-h' },
      { tab_key: 'contributions', item_key: 'standing', item_type: 'chart', is_visible: true, display_order: 17, custom_title: 'Standing', chart_type: 'donut' },
      { tab_key: 'contributions', item_key: 'floor-dist', item_type: 'chart', is_visible: true, display_order: 18, custom_title: "Nombre d'étages", chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'co-owners', item_type: 'chart', is_visible: true, display_order: 19, custom_title: 'Nb co-propriétaires', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'co-owners-gender', item_type: 'chart', is_visible: true, display_order: 20, custom_title: 'Genre co-propriétaires', chart_type: 'donut' },
      { tab_key: 'contributions', item_key: 'co-owners-nationality', item_type: 'chart', is_visible: true, display_order: 21, custom_title: 'Nationalité co-propriétaires', chart_type: 'bar-h' },
      { tab_key: 'contributions', item_key: 'ownership-tenure', item_type: 'chart', is_visible: true, display_order: 22, custom_title: 'Ancienneté propriété', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'title-in-name', item_type: 'chart', is_visible: true, display_order: 23, custom_title: 'Titre au nom du propriétaire', chart_type: 'donut' },
      { tab_key: 'contributions', item_key: 'title-issue-decade', item_type: 'chart', is_visible: true, display_order: 24, custom_title: 'Décennie émission titre', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'occupant-density', item_type: 'chart', is_visible: true, display_order: 25, custom_title: "Densité d'occupants", chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'lease-years', item_type: 'chart', is_visible: true, display_order: 26, custom_title: 'Durée des baux', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'rental-trend', item_type: 'chart', is_visible: true, display_order: 27, custom_title: 'Tendance locative', chart_type: 'area' },
      { tab_key: 'contributions', item_key: 'additional-constructions', item_type: 'chart', is_visible: true, display_order: 28, custom_title: 'Bâtiments secondaires', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'buildings-per-parcel', item_type: 'chart', is_visible: true, display_order: 29, custom_title: 'Bâtiments par parcelle', chart_type: 'bar-v' },
      { tab_key: 'contributions', item_key: 'evolution', item_type: 'chart', is_visible: true, display_order: 30, custom_title: 'Évolution', chart_type: 'area', col_span: 2 },
    ],
    kpis: [
      ...
      { tab_key: 'contributions', item_key: 'kpi-hosting', item_type: 'kpi', is_visible: true, display_order: 7, custom_title: 'Cap. accueil' },
      { tab_key: 'contributions', item_key: 'kpi-multi-owner', item_type: 'kpi', is_visible: true, display_order: 8, custom_title: 'Multi-prop.' },
      { tab_key: 'contributions', item_key: 'kpi-multi-constr', item_type: 'kpi', is_visible: true, display_order: 9, custom_title: 'Multi-constr.' },
    ],
  },
  'expertise': {
    label: 'Expertise',
  ...
  'rental-market': {
    ...
    charts: [
      ...
      { tab_key: 'rental-market', item_key: 'rent-by-commune', item_type: 'chart', is_visible: true, display_order: 11, custom_title: 'Loyer moyen par commune', chart_type: 'bar-h' },
      { tab_key: 'rental-market', item_key: 'rent-by-quartier', item_type: 'chart', is_visible: true, display_order: 12, custom_title: 'Loyer moyen par quartier', chart_type: 'bar-h' },
      { tab_key: 'rental-market', item_key: 'height-by-commune', item_type: 'chart', is_visible: true, display_order: 13, custom_title: 'Hauteur moyenne par commune', chart_type: 'bar-h' },
      { tab_key: 'rental-market', item_key: 'height-by-quartier', item_type: 'chart', is_visible: true, display_order: 14, custom_title: 'Hauteur moyenne par quartier', chart_type: 'bar-h' },
      { tab_key: 'rental-market', item_key: 'geo', item_type: 'chart', is_visible: true, display_order: 15, custom_title: 'Géographie' },
      { tab_key: 'rental-market', item_key: 'evolution', item_type: 'chart', is_visible: true, display_order: 16, custom_title: 'Évolution des déclarations marchandes', chart_type: 'area', col_span: 2 },
    ],
    kpis: [
