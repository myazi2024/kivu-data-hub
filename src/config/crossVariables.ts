...
export const CROSS_VARIABLE_REGISTRY: Record<string, Record<string, CrossVariable[]>> = {
  ...
  'parcels-titled': {
    ...
    'gender': [{ label: 'Usage', field: 'declared_usage' }, { label: 'Catégorie', field: 'property_category' }, { label: 'Province', field: 'province' }],
    ...
    'construction-decade': [{ label: 'Province', field: 'province' }, { label: 'Usage', field: 'declared_usage' }, { label: 'Catégorie', field: 'property_category' }],
  ...
  'contributions': {
    ...
    'fraud-reason': [{ label: 'Type contribution', field: 'contribution_type' }, { label: 'Province', field: 'province' }, { label: 'Statut', field: 'status' }],
  ...
  'expertise': {
    ...
    'building-position': [{ label: 'Province', field: 'province' }],
    ...
    'construction-decade': [{ label: 'Province', field: 'province' }, { label: 'Qualité', field: 'construction_quality' }, { label: 'Condition', field: 'property_condition' }],
